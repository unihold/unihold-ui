...
import './App.css';
import { Container, Navbar, Nav, Row, Col, Button, Image, Card, Accordion } from 'react-bootstrap';
...
let web3 = new Web3(window.ethereum);
  ...
  <Card>
    ...
    <Accordion.Collapse eventKey="0">
      <Col>
      <input className="textbox-input" placeholder="0.0" onChange={v => setBuyAmount(v)}></input>
  ...
  <Card>
    ...
    <Accordion.Collapse eventKey="3">
     <Col>
       <input className="textbox-input" placeholder="0.0" onChange={v => setSellAmount(v)}></input>
  ...
  <Card>
    ...
    <Accordion.Collapse eventKey="4">
     <Col>
      <input className="textbox-input" placeholder="To address: 0x..." onChange={v => setTransferToAddress(v)}></input>
              <input className="textbox-input" placeholder="0.0" onChange={v => setTransferAmount(v)}></input>
